        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-col-reverse lg:grid lg:grid-cols-12 gap-8 relative items-start">
            ...
            <div id="calculator" className="lg:col-span-5 relative scroll-mt-24">
              <div className="sticky top-[calc(var(--nh)+3rem)] self-start z-30 space-y-6 max-h-[calc(100vh-6rem)] overflow-y-auto pb-8 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                <motion.div
